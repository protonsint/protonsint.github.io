...
$bhavcopy_file = sprintf('fo%s%s%dbhav.csv.zip', 
	$date->format('d'), 
...
/*
https://www.nseindia.com/content/historical/EQUITIES/2017/JUL/cm28JUL2017bhav.csv.zip
https://www.nseindia.com/content/historical/DERIVATIVES/2017/JUL/fo28JUL2017bhav.csv.zip

*/
$bhavcopy_url = sprintf('https://www.nseindia.com/content/historical/DERIVATIVES/%d/%s/%s', 
	$date->format('Y'), 
	strtoupper($date->format('M')), 
	$bhavcopy_file
);
